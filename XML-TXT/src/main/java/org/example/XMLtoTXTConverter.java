    ...
    public static void convertXMLtoTXT(File inputFile) {
        try {
            ...
            if(invoiceLines.get(0).getItem().getClassifiedTaxCategory().getPercent().equals("0.00")) {
                ...
                writer.newLine();
                writer.write("TotalArticole=" + invoiceLines.size()*2);
            }
            ...
            for (int i = 0; i < invoiceLines.size(); i++) {
                ...
                float percent = Float.parseFloat(invoiceLine.getItem().getClassifiedTaxCategory().getPercent());
                ...
                writer.newLine();
                writer.write("Item_" + (i+1) + "=" + itemCode + ";" + "Lei;" + "1.00;" + invoiceLine.getLineExtensionAmount() + ";;0;");}
                else{
                    writer.newLine();
            ...
            for (int i = 0; i < invoiceLines.size(); i++) {
                ...
                writer.newLine();
                writer.write("Item_" + (i+invoiceLines.size()+1) + "=3;" + "Buc" + ";" + "1.00;" + "-" + tvas[i] + ";;0;");
